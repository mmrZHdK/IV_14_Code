...
function zeichneSektor ( x, y, rad, startW, endW ) {
  ...
  // Pfad am Schluss schliessen, erzeugt automatisch die zweite Strecke
  pfadString += "Z";
  //console.log( "pfadString:" + pfadString );
  
  var sektor = window.graphPapier.append( 'path' )
    .attr( 'd', pfadString )
...
function zeichneGraph( tortenSektorAnteil, tortenSumme ) {
  ...
  window.graphPapier = d3.select( '#graph' ).append( 'svg' )
    .attr( "width", 300 )
    .attr( "height", 300 );
